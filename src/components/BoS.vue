<template>
  ...
  <div>
      ...
      <div class="row-parallax-bg">
        <div class="parallax-wrapper">
          <div class="parallax-bg">
            <img src="images/the-division-2.jpg" alt="The Division 2">
          </div>
        </div>
    ...
    <section class="grey-bg">
        <div class="container">
          <div class="title text-center">
            <h2>The Division 2 Brotherhood</h2>
          </div>
          <div class="section-content pt-25 pb-25">
            <div class="row">

              <div class="col-md-3 col-sm-6" v-for="gamer in gamerData" :key="gamer.pid">
                <HomePageGamerCard :gamer="gamer" />
              </div>
...
<script>
import HomePageGamerCard from './HomePageGamerCard.vue';
